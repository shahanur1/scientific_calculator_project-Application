...
root.resizable(0, 0)
root.geometry("850x618+0+0")
root.configure(background="White")

calc=Frame(root,bg="powder blue")
calc.grid()

Label1 = Label(calc, text = "Made By Shahanur Islam Shagor",fg="Black",font=('arial',18,'bold','italic'))
Label1.grid(row=0, columnspan=4,column=4)

equa = "" 
equation = StringVar()
calculation = Entry(calc, textvariable = equation,fg="Black",font=('arial',15,'bold'),bg="powder blue",bd=30,width=28,justify=RIGHT)
...
Button14.grid(row = 7, column = 0, padx=10, pady=10)
...
Button15.grid(row = 7, column = 1, padx=10, pady=10)
...
Button16.grid(row = 7, column = 2, padx=10, pady=10)
...
Equal.grid(row=6, column=1, padx=10, pady=10)

Clear = Button(calc, text="C", command = ClearPress, borderwidth=1,bd=4,width=6,height=1,bg="powder blue", relief=SOLID,font=('arial',15,'bold'))
...
Button17.grid(row = 7, column = 3, padx=10, pady=10)
